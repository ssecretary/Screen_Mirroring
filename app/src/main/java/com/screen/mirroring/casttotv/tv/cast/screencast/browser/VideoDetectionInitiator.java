...
public class VideoDetectionInitiator {
    ...
    private WebActivity.ConcreteVideoContentSearch videoContentSearch;

    public VideoDetectionInitiator(WebActivity.ConcreteVideoContentSearch videoContentSearch) {
