...
package com.screen.mirroring.casttotv.tv.cast.screencast.dlna.model.mediaserver;
...
import com.screen.mirroring.casttotv.tv.cast.screencast.dlna.model.upnp.MediaCompleteListener;
...
public class MediaServer extends fi.iki.elonen.SimpleWebServer implements MediaCompleteListener {
    ...
    public void createLocalDevice() throws ValidationException {
        ...
        DeviceDetails details = new DeviceDetails("",
                new ManufacturerDetails(ctx.getString(R.string.app_name), "http://jksol.com/"),
                new ModelDetails(ctx.getString(R.string.app_name), "http://jksol.com/"),
    ...
    public void onMediaComplete() {
        Intent intent = new Intent("playNextVideo");
    ...
    public Response serve(String uri, Method method, Map<String, String> header, Map<String, String> parms,
        ...
        try {
            ...
            if (res != null) {
                ...
                res.addHeader("Server", "DLNADOC/1.50 UPnP/1.0 Cling/2.0 ScreenMirroring/" + "0.0" + " Android/" + Build.VERSION.RELEASE);
            }
