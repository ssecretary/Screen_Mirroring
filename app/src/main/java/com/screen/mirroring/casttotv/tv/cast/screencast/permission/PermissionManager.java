package com.screen.mirroring.casttotv.tv.cast.screencast.permission;
...
public class PermissionManager {
    ...
    public static void init(Context context) {
        sharedPreferences = context.getSharedPreferences("screen_mirroring", Context.MODE_PRIVATE);
